...
/* VOID:DOUBLE,DOUBLE (../../src/marshal.cmd:1) */
void
...
/* VOID:DOUBLE,DOUBLE,DOUBLE,DOUBLE (../../src/marshal.cmd:2) */
void
g_cclosure_user_marshal_VOID__DOUBLE_DOUBLE_DOUBLE_DOUBLE (GClosure     *closure,
                                                           GValue       *return_value,
                                                           guint         n_param_values,
                                                           const GValue *param_values,
                                                           gpointer      invocation_hint,
